-- Importação de arquivos de Demonstrações Contábeis para o PostgreSQL
...
-- Atualização dos dados carregados com o ano e o trimestre corretos
...
-- Importação do arquivo de Operadoras Ativas para o PostgreSQL
...
-- Atualização do nome fantasia das operadoras para 'Não informado' caso este seja nulo
